...
let brandons_car = new Car

console.log(brandons_car)
...
let brandons_sportscar = new Sport

console.log(brandons_sportscar)
...
class Truck extends Factory{
  constructor(model, color, enginesize, hitch, bed, navigation, backupcamera, audio, trim, doors, warranty){
    super(warranty)
    this.model = model
    this.color = color
...
let brandons_truck = new Truck

console.log(brandons_truck)
